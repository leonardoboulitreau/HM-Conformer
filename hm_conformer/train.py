...
def test(framework, loader, run_on_ddp=False):
    # enrollment
    eer_repo, scores, labels, filenames, eer, dcf, cllr = df_test(framework, loader, run_on_ddp=run_on_ddp, get_scores=True)
