...
def get_args():
    ...
    system_args = {
        ...
        # datasets
        'path_train'    : '/data/ASVspoof2024',
        'path_test'     : '/data/ASVspoof2021_DF',
        'path_dev2024'  :  '/data/ASVspoof2024',
        'path_eval2024'  : '/data/ASVspoof2024',
        'path_test_LA'  : None,
    ...
    experiment_args = {
        ...
        'DA_wav_aug_params' :  {
            'sr': 16000,
            'ACN': {'min_snr_in_db': 10, 'max_snr_in_db': 40, 'min_f_decay': -2.0, 'max_f_decay': 2.0, 'p': 0.0},
            'HPF': {'min_cutoff_freq': 20.0, 'max_cutoff_freq': 2400.0, 'p': 0.0},
            'LPF': {'min_cutoff_freq': 150.0, 'max_cutoff_freq': 7500.0, 'p': 0.0},
            'GAN': {'min_gain_in_db': -15.0, 'max_gain_in_db': 5.0, 'p': 0.0}
        },
    ...
    args['path_scripts'] = '/results/BASELINE-crua/HM-Conformer/'
    args['pt_epoch_select'] = '0'
    args['path_params'] = args['path_scripts'] + '/models'
