...
def get_args():
    ...
    system_args = {
        # experiment info
        'project'       : 'EVAL-baseline_with_speedaug-besteer',
        'name'          : 'HM-Conformer',
        'tags'          : [],
        'description'   : '',
    ...
    experiment_args = {
        ...
        'with_emphasis'     : True, 
        'with_energy'       : True,
        'train_crop_size'   : 16000 * 10,
        'val_crop_size'     : 16000 * 10,
        'test_crop_size'    : None,
    ...
    args['path_scripts'] = '/results/TRAIN-baseline_with_speedaug/HM-Conformer/'
    args['pt_epoch_select'] = '14'
