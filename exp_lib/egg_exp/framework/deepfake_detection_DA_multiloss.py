...
class DeepfakeDetectionFramework_DA_multiloss(Framework):
    ...
    def load_model(self, args):
        ...
        param_list = ['frontend',
                      ...
                      'loss3',
                      'loss4',]
        load_param_list = ['check_point_DF_frontend_' + epoch + '.pt',
                      'check_point_DF_backend0_' + epoch + '.pt',
                      'check_point_DF_backend1_' + epoch + '.pt',
                      'check_point_DF_backend2_' + epoch + '.pt',
                      'check_point_DF_backend3_' + epoch + '.pt',
                      'check_point_DF_backend4_' + epoch + '.pt',
                      'check_point_DF_loss0_' + epoch + '.pt',
                      'check_point_DF_loss1_' + epoch + '.pt',
                      'check_point_DF_loss2_' + epoch + '.pt',
                      'check_point_DF_loss3_' + epoch + '.pt',
                      'check_point_DF_loss4_' + epoch + '.pt',]
